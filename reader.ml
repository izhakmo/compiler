...
module Reader: sig
  ...
  val integer_generator : char option * char list -> sexpr
...
let integer_generator (l, tl) = match l with
...
let nt_integer = (pack (caten (maybe sign) natural) integer_generator);;
